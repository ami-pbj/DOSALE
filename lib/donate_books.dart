                                  ...
                                  Container(
                                    ...
                                    child: TextButton(
                                      ...
                                      child: const Center(
                                        ...
                                        child: Center(
                                          child: Text(
                                            'Address: Flutter St., Android Colony',
                                            textAlign: TextAlign.left,
                                            style: TextStyle (
                                              fontSize: 16,
                                              fontWeight: FontWeight.w500,
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                children: [
                                  const Padding(
                                    padding: EdgeInsets.only(top: 0, left: 10, right: 0, bottom: 30),
                                  ...
                                  Container(
                                    // frame30s2G (103:686)
                                    margin: const EdgeInsets.fromLTRB(10, 10, 0, 40),
                                    width: 130,
                                    height: 55,
                  ...
                  Column(
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text("Become a Seller with Us !!",
                            style: TextStyle(
                              fontSize: 20.0,
                              fontWeight: FontWeight.w700,
                              color: Colors.white,
                        ...
                        children: [
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              height: 150,
                              child: Image.asset(
                                'assets/book-types/images/sell_book.png',
                                fit: BoxFit.fitWidth,
                              ),
                            ),
                          ),
